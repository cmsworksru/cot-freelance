<!-- BEGIN: MAIN -->
<li id="notifications-menu" class="us_rm dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="fa fa-bell-o"></i> <span class="label label-warning">{PAGENAV_COUNT}</span> </a>
  <ul class="dropdown-menu">
    <li class="header textcenter"><!-- IF {PAGENAV_COUNT} > 0 -->У вас {PAGENAV_COUNT|cot_declension($this, 'Events_n')}<!-- ELSE -->{PHP.L.Events_empty_new}<!-- ENDIF --></li>
    <li>
